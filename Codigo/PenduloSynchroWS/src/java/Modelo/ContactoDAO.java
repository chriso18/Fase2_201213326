...
public class ContactoDAO {
    ...
    public String RegistrarContacto(String nombre, String apellido, String correo, String usuario, String pass, String nacimiento, String imagen){
    ...
    public String ActualizarContacto(String nombre, String apellido, String usuario, String pass, String nacimiento, String banco, String imagen, String correo){
        String respuesta=null;
        Connection accesoDB = Conectando.obtener();
        try {
    ...
    public String EliminarContacto(String Alias, String Correo) {
           String respuesta=null;
        Connection accesoDB = Conectando.obtener();
        try {
