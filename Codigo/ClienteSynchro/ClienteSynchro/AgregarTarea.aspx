<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarTarea.aspx.cs" Inherits="ClienteSynchro.Tarea" %>
                ...
                <div class="auto-style2">
                    ...
                    <table class="auto-style11" align="center">
                        <tr>
                            ...
                            <td class="auto-style20" colspan="2" rowspan="6">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="auto-style12">Participantes</td>
                            <td class="auto-style13">
                        ...
                        <tr>
                            <td class="auto-style12">Pertenece</td>
                            <td class="auto-style13">
                                <asp:TextBox ID="TextSoporte" runat="server" Width="206px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style21">Visibilidad</td>
