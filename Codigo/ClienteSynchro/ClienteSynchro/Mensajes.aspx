<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mensajes.aspx.cs" Inherits="ClienteSynchro.Mensajes" %>
...
-->	
	...
	<body>
        ...
        <div class="text-center">
            &nbsp;<asp:Panel ID="Panel1" runat="server" BackColor="#CCCCFF" Height="213px" style="text-align: left" Width="515px">
                        &nbsp;<br /> &nbsp;&nbsp;
                        <asp:Image ID="Image1" runat="server" Height="56px" ImageUrl="/Imagen/Perfil/i01.jpg" Width="54px" />
                        <br />
                        <br />
                        &nbsp;&nbsp;
                        <asp:TextBox ID="TextBox1" runat="server" Height="59px" TextMode="MultiLine" Width="477px"></asp:TextBox>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnPublicar" runat="server" BackColor="#9966FF" Text="Publicar" Height="29px" Width="70px" />
                    </asp:Panel>
                    <br />
            <asp:Panel ID="Panel2" runat="server" BorderStyle="Double" Height="179px" ScrollBars="Vertical">
		...
		<section id="footer_bottom_area">
			<div class="clearfix wrapper footer_bottom">
				<div class="clearfix copyright floatleft">
					<p> Copyright &copy; All rights reserved by t &copy; All rights reserved by <span>Wpfreeware.com</span></p>
				</div>
